...
class Contact extends Component{
  render(){
    ...
    return(
      ...
      <div className="contact flex-center pt-4 col-12 home">
      <div className='col-md-8'>
        <h1 className='text-center'>Me contacter</h1>
        
        <div className="wrapper">
               <li className="iconp facebook">
                  <span className="tooltip">Mahefa Andriamihaja</span>
                  <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-skype" viewBox="0 0 16 16">
               ...
               <li className="iconp twitter">
                  <span className="tooltip">marinotandria@gmail.com</span>
                  <span> <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-envelope" viewBox="0 0 16 16">
               ...
               <li className="iconp github">
                  <span className="tooltip">Mahefa-Int</span>
                  <span>
               ...
               <li className="iconp youtube">
                  <span className="tooltip">0343828723</span>
                     <span><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-phone-flip" viewBox="0 0 16 16">
